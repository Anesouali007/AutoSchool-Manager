...
public class ajouter_candidat extends javax.swing.JFrame {
    ...
    public void inserer_candidat() {
        if (valider_formulaire() == true) {
            ...
            try {
                ...
                st.setBytes(8, user_image);
                st.setString(9, sexes);
                st.setString(10, carte_id);
                st.executeUpdate();
                JOptionPane.showMessageDialog(null, "Candidat ajouté avec succès", null, JOptionPane.INFORMATION_MESSAGE);
                if (acceuil.EmailSender(emails, "Confirmation d'inscription ", "Bonjour,\n Votre Inscription à l'auto école YAZID-ECOLE à été bien effectué consulter votre email pour voir votre état d'avancement\nMerci !\n\n Coridalement.") == false) {
                    JOptionPane.showMessageDialog(null, "L'adresse email est incorrecte réssayer l'inscription  ", null, JOptionPane.ERROR_MESSAGE);
                }
                instance.dispose();
    ...
    public void modifier_candidat() {
        try {
            if (valider_formulaire() == true) {
                ...
                Long date_date = date_naissance.getTime();
                java.sql.Date date_nais = new java.sql.Date(date_date);
                String update_vehicule = "update candidats set nom=?,prenom=?,date_naissance=?,adresse=?,telephone=?,email=?,categorie=?,sexe=?,carte_identite=? where id_candidat=?";
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Adresse Email");
        ...
        categorie.setColorArrow(new java.awt.Color(0, 102, 153));
        categorie.setColorBorde(new java.awt.Color(255, 255, 255));
        categorie.setColorFondo(new java.awt.Color(0, 102, 153));
        categorie.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N

        jLabel7.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Categorie Permis");
                        ...
                        .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(kGradientPanel1Layout.createSequentialGroup()
                                .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(input_prenom, javax.swing.GroupLayout.DEFAULT_SIZE, 326, Short.MAX_VALUE)
                                    .addComponent(input_nom, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .addGap(0, 0, Short.MAX_VALUE))
                            .addGroup(kGradientPanel1Layout.createSequentialGroup()
                                .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        ...
                                        .addComponent(categorie, javax.swing.GroupLayout.DEFAULT_SIZE, 326, Short.MAX_VALUE))
                        ...
                        .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, kGradientPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        .addComponent(inpute_carte, javax.swing.GroupLayout.DEFAULT_SIZE, 350, Short.MAX_VALUE)
