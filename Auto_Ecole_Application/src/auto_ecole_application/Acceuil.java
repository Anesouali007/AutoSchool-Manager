...
public class Acceuil extends javax.swing.JFrame {
    ...
    public boolean validation_formulaire() {
        ...
        if (email.isEmpty() || password.isEmpty()) {
            ...
            if (!email.matches("^.+@.+\\..+$")) {
                JOptionPane.showMessageDialog(null, "Votre email n'est pas valide !", null, JOptionPane.ERROR_MESSAGE);
                valide = false;
            }
        }
        return valide;
    ...
    public void connecter() {
        if (validation_formulaire() == true) {
            ...
            try {
                con = connection_db();
                PreparedStatement st = con.prepareStatement("select * from administrateur where Email=? and mot_de_passe= ?");
                ...
                if (rs.next() == true) {
                    ...
                    JOptionPane.showMessageDialog(null, " E-mail ou mot de passe incorrecte !", null, JOptionPane.ERROR_MESSAGE);
                }
            } catch (Exception e) {
                e.printStackTrace();
    ...
    public void mot_passe_oublie(String email) {
        try {
            con = connection_db();
            PreparedStatement st = con.prepareStatement("select * from administrateur where Email=?");
            st.setString(1, email);
            rs = st.executeQuery();
            if (rs.next()) {
                String password = rs.getString("mot_de_passe");
                EmailSender(email, "Récuperation du mot de passe", "Voisi votre mot de passe vous pouvez le modifier plus tard : \n\n\n" + password);
            } else {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Authentifiez-vous pour plus d'informations");
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons/icons8_Secured_Letter_50px.png"))); // NOI18N
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(input_email, javax.swing.GroupLayout.PREFERRED_SIZE, 494, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jLabel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseClicked
        ...
        if (emails.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Vous devez saisir votre Email ! ", null, JOptionPane.ERROR_MESSAGE);
        }
        else{
            mot_passe_oublie(emails);
        }
